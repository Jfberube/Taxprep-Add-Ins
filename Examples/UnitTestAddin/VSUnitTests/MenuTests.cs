...
namespace VSUnitTestAddin
{
    ...
    public class MenuTests
    {
        ...
        public static void InitTestEvents(IAppSubMenu aParentSubMenu, bool aSeparatorBefore)
        {
            ...
            lSubMenu.PopupHandler = new TxpAddinLibrary.Handlers.AppNotifyHandler(() =>
            {
                SubMenuPopupCount++;
            ...
            lMenuItem.ClickHandler = new TxpAddinLibrary.Handlers.AppNotifyHandler(() =>
            {
                MenuItemClickCount++;
                System.Media.SystemSounds.Beep.Play();
            });
        ...
        {
            var testHandler = new TxpAddinLibrary.Handlers.AppNotifyHandler(null);
