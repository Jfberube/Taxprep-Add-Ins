...
namespace VSUnitTestAddin
{
    ...
    public class ModuleManagerTests
    {
        ...
        public static void InitTestEvents(IAppInstance aAppInstance)
        {
            ...
            lService.BeforeCurrentModuleChange = new TxpAddinLibrary.Handlers.ModuleManager.NotifyHandler(aModule => BeforeCurrentModuleChangeCount++);
            lService.AfterCurrentModuleChange = new TxpAddinLibrary.Handlers.ModuleManager.NotifyHandler(aModule => AfterCurrentModuleChangeCount++);
        }
        ...
        public void TestModuleManager()
        {
            ...
            var testHandler = new TxpAddinLibrary.Handlers.ModuleManager.NotifyHandler(null);
