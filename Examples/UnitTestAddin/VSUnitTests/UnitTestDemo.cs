...
namespace UnitTestDemo
{
    ...
    public class UnitTest1
    {
        ...
        */
        ...
        {
            int LFilesCount = FClientFileManager.GetCount();
        ...
        public void CellAfterCalcCycle()
        {
            ...
            string LCellPath = LTaxCell.GetCellNameWithGroup();
        ...
        { 
            ...
            string LGroupName = LGroup.GetName(true);
            FClientFileManager.GetCurrentClientFile().RunCalcForAllReturns();
        ...
        public void GroupByNameAfterCalcCycle()
        {
            ...
            string LNamedGroupName = LGroupByName.GetName(true);
